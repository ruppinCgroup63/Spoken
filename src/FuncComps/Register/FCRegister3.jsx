...
function RegistrationPage3(props) {
  ...
  const [user, setUsers] = useState({
    ...
    DomainName: userObj.user.DomainName,
        ...
        >
          <div className="card-body flex items-center justify-center">
            ...
            <form onSubmit={handleSubmit}>
              ...
              {emailExists && (
                <ErrorMessage message="The email already exists. Please use a different email." />
              )}{" "}
              {/* תצוגת הודעת השגיאה */}
              <br />
              <br />
              <b>
                <h1 style={{ fontSize: "15px" }}>Set a signature</h1>
              </b>
              <span style={{ fontSize: "12px" }}>
                set your signature in the rectangle below
              </span>
              <br />
              <br />
              <SignatureCanvas
