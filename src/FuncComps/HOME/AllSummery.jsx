...
useEffect(() => {
  ...
  const handleCustomerChange = (event) => {
    ...
    if (customerId === '') {
      ...
      const filtered = summaries.filter(summary => summary.customerId === customerId);
        ...
        <div className="card-body flex flex-col items-start justify-center">
          <header className="flex justify-between items-start w-full align-self-start mb-4">
            ...
            <label
              ...
              style={{ backgroundColor: "#E4E9F2", alignSelf: "start", borderColor: "#E4E9F2", marginTop: "-18px", marginRight: "-15px" }}
            >
              <input type="checkbox" />
              <svg className="swap-off fill-current" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 512 512">
          ...
          <div className="flex items-center" style={{ marginBottom: "2rem", marginTop: "2rem", width: "100%" }}>
            <select
