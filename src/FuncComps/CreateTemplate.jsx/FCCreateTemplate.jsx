                    ...
                    <div className="card-body flex items-center justify-center">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div style={{ overflow: 'hidden', whiteSpace: 'nowrap', textOverflow: 'ellipsis', }} className="steps">
                                <div style={{ marginRight: '1rem' }} className="step step-primary">name</div>
                                <div style={{ marginRight: '1rem' }} className="step ">Template<br></br>structure</div>
                                <div style={{ marginRight: '1rem' }} className="step ">Extras</div>
                            </div>
                            <br /><br />
                            <h3 className="card-title text-dark-blue-500" style={{ display: 'block', margin: '0 auto', marginBottom: '0.5rem' }}>Template name?</h3>

                            <div className="form-control">
                                <label className={`input input-bordered flex items-center gap-2 relative ${errors.name ? 'input-error' : ''}`} >
                                    <input
                                        type="text"
                                ...
                                {errors.name && (
                                    <p id="name-error" className="text-red-500 mt-2">{errors.name}</p>
                                )}
                            </div>
                            <div className="button-container" >
                                ...
                                <div className="form-control mt-6">
                                    <button type="submit"
                                        className="btn btn-md btn-primary  btn-primary">Continue</button>
                                </div>
                            </div>
                            <div className="mt-10 mt-4 flex items-center justify-center">
                                <div className="w-40 h-40" style={{ marginTop: '2rem' }}>
                                    <img src="/public/createTemplate/createTem.png" alt="Error" className="w-full h-full object-contain" />
                                </div>
