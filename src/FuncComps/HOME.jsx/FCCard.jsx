...
function Card() {
  ...
  return (
    <div className="card max-w-md mx-auto bg-white shadow-xl relative p-5">
  <div className="card-body flex items-center justify-between" style={{ padding: '0 0.5rem' }}>
  ...
  <div className="mt-4 bg-white"> 
    <textarea className="textarea textarea-bordered h-24 w-full bg-white" placeholder="A description of the template"></textarea>
  </div>
