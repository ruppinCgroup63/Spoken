...
const ForgotPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`https://localhost:44326/api/Users/ForgotPassword?email=${encodeURIComponent(email)}&Password=${encodeURIComponent(Password)}`, {
        method: "POST",
        headers: {
    ...
    <div className="flex items-center justify-center min-h-screen bg-light-blue-500">
      <div className="card w-full max-w-md bg-base-100 shadow-xl p-5" style={{ backgroundColor: "#E4E9F2" }}>
        <div className="card-body flex items-center justify-center">
          <h2 className="card-title text-center text-dark-blue-500" style={{ color: "#070A40", marginBottom: "20px", marginTop: "50px" }}>Forgot Password</h2>
          <form onSubmit={handleSubmit} className="w-full">
            <label className="btn btn-circle swap swap-rotate" style={{ position: "absolute", top: "30px", left: "20px", backgroundColor: "#E4E9F2", borderColor: "#E4E9F2" }}
              onClick={() => navigate("/")}
            >
              <input type="checkbox" />
            ...
            <button
              ...
              style={{ backgroundColor: "#070A40", color: "#E4E9F2", borderColor: "#070A40" }}
            >
              Update Password
            </button>
            </div>
