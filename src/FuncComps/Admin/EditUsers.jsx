                ...
                <div>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div style={{ marginBottom: '1rem' }}>
                            <label style={{ display: 'block', marginBottom: '0.5rem', color: '#007BFF' }}>Username</label>
                            <input
                                type="text"
                                name="UserName"
                                value={user.UserName}
                        ...
                        <div style={{ marginBottom: '1rem' }}>
                            <label style={{ display: 'block', marginBottom: '0.5rem', color: '#007BFF' }}>Email</label>
                            <input
                                type="email"
                                name="Email"
                                value={user.Email}
                        ...
                        <div style={{ marginBottom: '1rem' }}>
                            <label style={{ display: 'block', marginBottom: '0.5rem', color: '#007BFF' }}>Phone</label>
                            <input
                                type="text"
                                name="Phone"
                                value={user.Phone}
                        ...
                        <div style={{ marginBottom: '1rem' }}>
                            <label style={{ display: 'block', marginBottom: '0.5rem', color: '#007BFF' }}>Language</label>
                            <input
                                type="text"
                                name="LangName"
                                value={user.LangName}
